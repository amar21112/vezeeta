@php
    ...
    $nav_items = [
        ...
        'password' => [
            ...
            'url' => '/dashboard/patient/change-password',
        ],
        'insurance' => [
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-6">
        ...
        <div class="text-center mb-6">
            <div class="relative inline-block">
                <img src="<?php echo htmlspecialchars($patient_avatar); ?>" alt="Profile Picture"
                    class="w-24 h-24 rounded-full mx-auto mb-3 border-4 border-blue-100 object-cover">
                <button
                    class="absolute bottom-0 right-0 bg-blue-600 text-white rounded-full p-2 text-xs hover:bg-blue-700 transition-colors"
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            <div class="text-center">
                ...
                <button onclick="contactSupport()" class="text-xs text-blue-600 hover:text-blue-800 underline">
                    Contact Support
                </button>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl p-6 max-w-md w-full mx-4">
        ...
        <div class="space-y-4">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button onclick="uploadAvatar()" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                    Upload
                </button>
            </div>
        </div>
